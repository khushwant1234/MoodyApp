    ...
    >
      <div className="relative w-full">
        ...
        <div className="absolute right-4 bottom-4 flex gap-2 z-10">
          <button
            className={`h-8 w-8 rounded-full bg-white/80 backdrop-blur-sm flex items-center justify-center transition-opacity ${!canScrollLeft ? "opacity-50 cursor-not-allowed" : ""}`}
            onClick={scrollLeft}
          ...
          <button
            className={`h-8 w-8 rounded-full bg-white/80 backdrop-blur-sm flex items-center justify-center transition-opacity ${!canScrollRight ? "opacity-50 cursor-not-allowed" : ""}`}
            onClick={scrollRight}
        ...
        {open && (
          <div className="fixed inset-0 z-50 overflow-auto">
            ...
            >
              ...
              <motion.p className="text-base font-medium">{card.category}</motion.p>
              <motion.h2 className="text-2xl font-semibold mt-2">{card.title}</motion.h2>
